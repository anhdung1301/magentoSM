...
class Save extends Category
{
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('category')) {
            ...
            if (!$category) {
                $resultRedirect->setPath('sumup/*/', ['_current' => true]);
...
//            }
            ...
            $resultRedirect->setPath('sumup/*/edit', ['_current' => true, 'id' => $category->getId()]);

            return $resultRedirect;
        }

        $resultRedirect->setPath('sumup/*/edit', ['_current' => true]);
