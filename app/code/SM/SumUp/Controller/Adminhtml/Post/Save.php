...
//                $this->addHistory($post, $action);
                ...
                $this->_getSession()->setData('sumup_blog_post_data', false);
            ...
            $this->_getSession()->setData('sumup_blog_post_data', $data);
    ...
    protected function prepareData($post, $data = [])
    {
        ...
        $data['publish_date_form']   = $timezone->convertConfigTimeToUtc(isset($data['publish_date_form'])
            ? $data['publish_date_form'] : null);
