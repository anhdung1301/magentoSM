...
/**
 * Class Product
 * @package SM\SumUp\Block\Adminhtml\Post\Edit\Tab
 */
class Product extends Extended implements TabInterface
{
    ...
    /**
     * @return \SM\SumUp\Model\Post
     */
    public function getPost()
    {
        return $this->coreRegistry->registry('sm_blog_post');
    }
    ...
    {
        return $this->getUrl('sumup/post/products', ['_current' => true]);
    }
