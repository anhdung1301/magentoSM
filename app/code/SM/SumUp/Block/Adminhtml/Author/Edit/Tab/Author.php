...
namespace SM\SumUp\Block\Adminhtml\Author\Edit\Tab;
...
use SM\SumUp\Block\Adminhtml\Renderer\Image;
use SM\SumUp\Helper\Data;
use SM\SumUp\Helper\Image as ImageHelper;
...
class Author extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $author = $this->_coreRegistry->registry('sumup_blog_author');
    ...
    {
        return $this->getUrl('sumup/author/customergrid');
    }
}
