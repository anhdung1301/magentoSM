...
use SM\SumUp\Model\ResourceModel\Category;
use Zend_Db_Select;

/**
 * Class Tree
 * @package SM\SumUp\Model\ResourceModel\Category
 */
class Tree extends Dbp
{
    ...
    public function __construct(
        ...
        parent::__construct(
            $coreResource->getConnection('sumup_write'),
            $coreResource->getTableName('sm_blog_category'),
            [
    ...
    {
        $this->cache->clean([\SM\SumUp\Model\Category::CACHE_TAG]);
